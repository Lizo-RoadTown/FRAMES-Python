  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className={raceActive ? 'grid grid-cols-1 lg:grid-cols-3 gap-6' : ''}>
          {/* Ghost Race Sidebar (Race Mode Only) */}
          {raceActive && (
            <aside className="lg:col-span-1">
              <div className="sticky top-24">
                <GhostRace
                  elapsedTime={elapsedTime}
                  currentStep={currentStep}
                  totalSteps={moduleData.steps.length}
                  ghostData={ghostData}
          ...
          {/* Module Content */}
          <div className={raceActive ? 'lg:col-span-2' : ''}>
            {isPaused ? (
